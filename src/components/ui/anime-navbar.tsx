...
export function AnimeNavBar({ items, className, defaultActive = "Home" }: NavBarProps) {
  ...
  // Set the active tab based on the current path when component mounts
  useEffect(() => {
            ...
            return (
              ...
              >
                {isActive && (
                  ...
                  >
                    <div className="absolute inset-0 bg-indigo-600/25 rounded-full blur-md" />
                    <div className="absolute inset-[-4px] bg-indigo-600/20 rounded-full blur-xl" />
                    <div className="absolute inset-[-8px] bg-indigo-600/15 rounded-full blur-2xl" />
                    <div className="absolute inset-[-12px] bg-indigo-600/5 rounded-full blur-3xl" />
                    
                    <div 
                      className="absolute inset-0 bg-gradient-to-r from-indigo-600/0 via-indigo-600/20 to-indigo-600/0"
                      style={{
